...
public abstract class BeanUtils {
    ...
    public static PropertyDescriptor[] getPropertyDescriptors(Object bean) {
        try {
            ...
            throw new RuntimeException("Failed to get property descriptors for bean: " + bean, e);
        }
    }
    ...
    public static PropertyDescriptor getPropertyDescriptor(Class<?> clazz, String propertyName) {
        try {
            ...
            throw new RuntimeException("Failed to get property descriptor for class: " + clazz.getName(), e);
        }
        return null; // 如果未找到对应的属性描述符
    }
     ...
     * @param target 原有对象
     */
    public static void copyProperties(Object source, Object target) throws InvocationTargetException {
